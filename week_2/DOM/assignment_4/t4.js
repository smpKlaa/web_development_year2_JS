...
navigator.geolocation.getCurrentPosition((position) => {
  ...
  // Calculate distance to each restaurant and add distance to each to the array.
  for (let i = 0; i < restaurants.length; i++) {
    const distance = calcDistance(coords, restaurants[i].location.coordinates);
    restaurants[i].distance = distance * 100;
  }

  // Sort restaurants depending on their distance to user.
  restaurants.sort((a, b) => a.distance - b.distance);

  // Add all restaurants to the document. Sorted by distance.
...
// Function for calculating distance of two points.
